...
class Data_absensi extends MY_Controller
{
    ...
    public function praktikum()
    {
        ...
        // Data Perkuliahan
        $id_pelaksanaan_perkuliahan = $mk->row()->kd_mata_kuliah . "-" . $semester . "-PRAKTIKUM-1";
        $this->db->select('*')->from('pelaksanaan_perkuliahan');;
        $this->db->where('id_pelaksanaan_perkuliahan', $id_pelaksanaan_perkuliahan);
        $data_perkuliahan = $this->db->get();
        $data_perkuliahan = $data_perkuliahan->row();
        $this->mViewData['data_perkuliahan'] = $data_perkuliahan;
        ...
        // Data Absensi
        $id_absensi = $state_kd_mk . "-" . $semester . "-PRAKTIKUM-1";
        $this->db->select('*')->from('absensi');;
        $this->db->where('id_absensi', $id_absensi);
        $data_absensi = $this->db->get();
        ...
        $this->db->where('kd_ruang', $kd_ruang);
        $data_ruang = $this->db->get();
        $data_ruang = $data_ruang->row();
        $this->mViewData['data_ruang'] = $data_ruang;
        $kd_ruang = isset($data_ruang->kd_ruang) ? $data_ruang->kd_ruang : '';
        ...
        $this->add_stylesheet($cssFile, true);
        $this->render('data_absensi/praktikum', 'with_breadcrumb');
    }
