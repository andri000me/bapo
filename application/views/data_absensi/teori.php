...
<div class="container" style="color:black;">
    <div class="panel panel-default">
        ...
        <div align="center">
            ...
            <form action="dosen_data_absensi_teori_kueri_insert.php" method="post" role="form" class="contactForm">
                ...
                <div class="text-center" class="print-screen">
                    <button type="submit" name="submit" class="btn btn-primary btn-lg print-screen" required="required">Simpan</button>
                </div>
                </br>
            </form>
        </div>
