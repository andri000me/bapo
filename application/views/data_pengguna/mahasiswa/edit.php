        ...
        <div class="row contact-wrap">
            ...
            <div class="col-md-6 col-md-offset-3">
                <form method="post" role="form">
                    <input type="hidden" class="form-control" name="npm_old" id="npm_old" value="<?= $data->npm ?>">
                    ...
                    <div class="form-group">
                        <input value="<?= $data->npm ?>" type="number" class="form-control" name="npm" id="npm" minlength="1" placeholder="NPM" onblur="checkAvailability()" required>
                        <span id="user-availability-status"></span>
                    </div>
                    <div class="form-group">
                        <input value="<?= $data->nama_mahasiswa ?>" type="text" class="form-control" name="nama_mahasiswa" id="nama_mahasiswa" placeholder="Nama" minlength="1" required>
                    </div>
                    <div class="form-group">
