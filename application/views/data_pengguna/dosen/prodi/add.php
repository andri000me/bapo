        ...
        <div class="row contact-wrap">
            ...
            <div class="col-md-6 col-md-offset-3">
                <form method="post" role="form">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_tata_usaha" id="nama_tata_usaha" placeholder="Nama" minlength="1" required>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="jabatan" id="jabatan" placeholder="Jabatan" minlength="1" required>
                    </div>
                    <div class="form-group">
