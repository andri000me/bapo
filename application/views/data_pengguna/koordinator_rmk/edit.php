        ...
        <div class="row contact-wrap">
            ...
            <div class="col-md-6 col-md-offset-3">
                <form method="post" role="form">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_koordinator_rmk" id="nama_koordinator_rmk" placeholder="Nama" minlength="1" value="<?= $data->nama_koordinator_rmk ?>" required>
                    </div>
                    <div class="form-group">
