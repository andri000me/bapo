<section class="services">
    <div class="container" style="color:black;">
        <div class="panel panel-default">
            ...
            <div align="right">
                <a href="<?= base_url() ?>data_pengguna/tata_usaha_universitas?state=add">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    foreach ($data
                        ...
                        <tr>
                            ...
                            <td><?= $val->username ?></td>
                            <td>
                                <a href="<?= base_url() ?>data_pengguna/tata_usaha_universitas?state=edit&id=<?= $val->kd_user ?>">
                                    <img src="<?= base_url() ?>assets/images/edit_green.png" style="margin-left:10px;" width="30" height="30">
                                </a>

                                <a id="delete-row" href="<?= base_url() ?>data_pengguna/tata_usaha_universitas?state=delete&id=<?= $val->kd_user ?>" onclick="return deleteConfirmation()">
