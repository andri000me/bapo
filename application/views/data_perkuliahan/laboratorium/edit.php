        ...
        <div class="row contact-wrap">
            ...
            <div class="col-md-6 col-md-offset-3">
                <form method="post" role="form">
                    ...
                    <div class="form-group">
                        <input value="<?= $data->kd_ruang ?>" type="text" class="form-control" name="kd_ruang" id="kd_ruang" minlength="1" placeholder="Kode Laboratorium" onblur="checkAvailability()" required>
                        <span id="user-availability-status"></span>
                    </div>
                    <div class="form-group">
                        <input value="<?= $data->nama_lab ?>" type="text" class="form-control" name="nama_lab" id="nama_lab" placeholder="Nama Laboratorium" minlength="1" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input value="<?= $data->nik_dosen_pj ?>" type="text" class="form-control" name="nik_dosen_pj" id="nik_dosen_pj" placeholder="Dosen Panunggung Jawab" style="pointer-events:none; background:#F0F0F0;" required/>
                    </div>
