        ...
        <div class="row contact-wrap">
            ...
            <div class="col-md-6 col-md-offset-3">
                <form method="post" role="form">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" name="kd_ruang" id="kd_ruang" minlength="1" placeholder="Kode Ruang" onblur="checkAvailability()" required>
                        <span id="user-availability-status"></span>
                    </div>
                    <div class="form-group">
                        <input type="text" class="form-control" name="nama_ruang" id="nama_ruang" placeholder="Nama Ruang" minlength="1" required>
                    </div>
                    <div class="form-group">
            ...
            $.ajax({
                ...
                success: function (res) {
                    ...
                    if (data.status === 'error') {
                        $("#user-availability-status").html('<span style="color:red; font-weight:bold">&nbsp;&nbsp;Kode Ruang Tidak Tersedia</span>');
                        $("#btn-simpan").attr('disabled', true);
                    } else {
                        $("#user-availability-status").html('<span style="color:green; font-weight:bold">&nbsp;&nbsp;Kode Ruang Tersedia</span>');
