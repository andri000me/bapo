...
JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Pertama",sLast:"Terakhir",sNext:"Selanjutnya",sPrevious:"Sebelumnya"},sEmptyTable:"Tidak ada data yang tersedia",sInfo:"Menampilkan _START_ ke _END_ dalam _TOTAL_ data",sInfoEmpty:"Melihat 0 ke 0 dalam 0 data",sInfoFiltered:"(filtered from _MAX_ total data)",
sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Lihat dalam _MENU_ data",sLoadingRecords:"Menunggu...",sProcessing:"Sedang proses...",sSearch:"Cari: ",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Tidak ada data yang ditemukan"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(m.defaults);m.defaults.column={aDataSort:null,iDataSort:-1,
